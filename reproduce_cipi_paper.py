...
CIPI piano dataset, using the authors' own code/splits/features already
...
Run from the repo root:
    python reproduce_cipi_paper.py
"""
import json
import os
import sys
...
ALIAS = "cipi_paper_reproduction"
NUM_CLASSES = 9

# The paper's "basic" descriptor set (Chiu & Chen's 5 pairs + Pitch Set LZ
# pairs) -- this is the "RubricNet proposed" row in Table 4.
BASIC_FEATURES = [
    'rh_pitch_set_lz',
    'lh_pitch_set_lz',
    'rh_pitch_range',
...
def main():
    ...
    # Authors' final hyperparameters for the CIPI "basic" experiment
    # (interpretability.py parse_args defaults, alias "rubricnet_cameraready").
    args = Args(
        batch_size=40,
        patience=400,
        lr=0.1,
    ...
    print("\n=== CIPI reproduction (basic+LZ descriptors, 5-fold) ===")
